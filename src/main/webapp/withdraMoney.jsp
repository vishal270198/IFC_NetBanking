...
<body>
    ...
    <div class="container">
        ...
        <form action="Servic" method="post">
            ...
            <input type="text" name="amount" id="amount" placeholder="Enter Amount to Withdraw" required />

            <input type="submit" name="submit" value="Withdraw Money" />
            <input type="hidden" name="id" value="WM" />
        </form>
    </div>
